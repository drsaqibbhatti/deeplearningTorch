import torch
from block.separable_block import separable_block
...
class EntryFlow(torch.nn.Module):
    def __init__(self, activation=torch.nn.ReLU):
        ...
        self.layer1 = torch.nn.Sequential(
            separable_block(in_channels=64,
                            out_channels=128,
                            kernel_size=3,
                            stride=1,
                            padding='same',
            ...
            activation(),
            separable_block(in_channels=128,
                            out_channels=128,
                            kernel_size=3,
                            stride=1,
                            padding='same',
        ...
        self.layer2 = torch.nn.Sequential(
            ...
            activation(),
            separable_block(in_channels=256,
                            out_channels=256,
                            kernel_size=3,
                            stride=1,
                            padding='same',
        ...
        self.layer3 = torch.nn.Sequential(
            ...
            activation(),
            separable_block(in_channels=728,
                            out_channels=728,
                            kernel_size=3,
                            stride=1,
                            padding='same',
