import torch
from block.dense_block import dense_block
...
class densenet(torch.nn.Module):
    ...
    def __init__(self, class_num=5, block_config=(6, 12, 24, 16), expansion_rate=4, growth_rate=12, droprate=0.2, activation=torch.nn.ReLU):
        ...
        self.dense_layer1 = dense_block(num_input_features=inner_channels,
        ...
        self.dense_layer2 = dense_block(num_input_features=inner_channels,
                                            num_layers=num_layers,
                                            expansion_rate=self.expansion_rate,
                                            growth_rate=self.growth_rate,
                                            droprate=droprate,
        ...
        self.dense_layer3 = dense_block(num_input_features=inner_channels,
                                            num_layers=num_layers,
                                            expansion_rate=self.expansion_rate,
                                            growth_rate=self.growth_rate,
                                            droprate=droprate,
        ...
        self.dense_layer4 = dense_block(num_input_features=inner_channels,
                                            num_layers=num_layers,
                                            expansion_rate=self.expansion_rate,
                                            growth_rate=self.growth_rate,
                                            droprate=droprate,
...
def densenet121(class_num=4, expansion_rate=4, growth_rate=32, droprate=0.2, activation=torch.nn.ReLU):
    block_config=(6,12,24,16)
    return densenet(class_num=class_num, block_config=block_config, expansion_rate=expansion_rate, growth_rate=growth_rate, droprate=droprate, activation=activation)

def densenet169(class_num=4, expansion_rate=4, growth_rate=32, droprate=0.2, activation=torch.nn.ReLU):
    block_config=(6,12,32,32)
    return densenet(class_num=class_num, block_config=block_config, expansion_rate=expansion_rate, growth_rate=growth_rate, droprate=droprate, activation=activation)

def densenet201(class_num=4, expansion_rate=4, growth_rate=32, droprate=0.2, activation=torch.nn.ReLU):
    block_config=(6,12,48,32)
    return densenet(class_num=class_num, block_config=block_config, expansion_rate=expansion_rate, growth_rate=growth_rate, droprate=droprate, activation=activation)

def densenet264(class_num=4, expansion_rate=4, growth_rate=32, droprate=0.2, activation=torch.nn.ReLU):
